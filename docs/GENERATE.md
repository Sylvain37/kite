...
- Settings places the document title in bold, the translated quote in italics, `· v0.5.186 ·`, and the GitHub link below a separator after the data management controls.
...
- document title, quote, release `v0.5.186` and GitHub link in `app-info`, placed in its own Settings section after the data controls;
- toast region;
