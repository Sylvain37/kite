...
export const TRANSLATIONS = Object.freeze({
  ...
  directoryTeamMember: freezeVariants({ en: "Team member", fr: "Membre dՎquipe" }),
  ...
  directoryParent: freezeVariants({ en: "Parent branch or manager", fr: "Branche parente ou responsable" }),
